...
namespace SmartFlow.Shared.Helpers.Interfaces
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Set the culture based on the platform
        /// </summary>
        ...
        /// <summary>
        /// Overridden string method to return Platform String
        /// </summary>
        /// <returns></returns>
