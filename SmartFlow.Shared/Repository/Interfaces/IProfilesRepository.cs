...
namespace SmartFlow.Shared.Respository.Interfaces
{
    ...
    public interface IProfilesRepository
    {
        ...
        Task<IEnumerable<Profile_Dbo>> GetProfilesAsync();
        ...
        /// <returns></returns>
        Task<Profile_Dbo> GetProfileByIdAsync(int id);
        ...
        /// <returns></returns>
        Task<bool> AddProfileAsync(Profile_Dbo profile);
        ...
        /// <returns></returns>
        Task<bool> UpdateProfileAsync(Profile_Dbo profile);
        ...
        /// <returns></returns>
        Task<IEnumerable<Profile_Dbo>> QueryProfilesAsync(Func<Profile_Dbo, bool> predicate);
