...
namespace SmartFlow.Droid
{
    ...
    public class PicturePickerImplementation : IPicturePicker
    {
        ...
        public Task<Stream> GetImageStreamAsync()
        {
		 ...
		 /// <summary>
        /// This method is used to launch BioSDK MRZ reader.
        /// </summary>
        /// <returns></returns>
        public Task<Stream> GetBioSDK()
        {
            try
            {
                // Define the Intent for getting images
                Intent intent = new Intent();
                intent.SetAction("morpho.biosdk.thisone");

                // Get the MainActivity instance
                MainActivity activity = Forms.Context as MainActivity;

                // Start the picture-picker activity (resumes in MainActivity.cs)
                activity.StartActivityForResult(intent, MainActivity.PickBioSDK);
