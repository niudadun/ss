        ...
        public static List<Chapter> CreateDeclarationChapters()
        {
            var chapters = new List<Chapter>()
            {
                new Chapter()
                {
                     ...
                     ChapterClassId = ChapterIdentifiers.Trip.ToString(),
                     Questions = new List<Question>()
                     {
                          new Question()
                         {
                              ...
                              {
                                  MaxDate = Utils.GetDateInFormat(DateTime.Now.AddDays(15)),
                             ...
                             Answers = new List<Answer>()
                              {
                                  ...
                                  new Answer()
                                  {
                                      Order =2,
                                      Code = "CD1",
                                      Text = Helpers.L10n.GetDropDowneMappedString(DropDownData.CARRIED_CD_1),
                                  },
                              },
                              Config = new ValidationConfig()
                              {
                            ...
                            QuestionKey = "Static_QN_1",
                              ...
                              Answers = new List<Answer>()
                              {
                                  ...
                                  new Answer()
                                  {
                                      ...
                                      ConditionalQuestion = new List<ConditionalQuestion>{new ConditionalQuestion(QuestionIdenfiers.DIFFERENT_PASSPORT_NAME) }
                                  },
                                  new Answer()
                                  {
                                      Order =3,
